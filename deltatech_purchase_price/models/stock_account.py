...
class StockMove(models.Model):
    ...
    def _get_price_unit(self):
        ...
        if self.purchase_line_id:
            update_product_price = self.env['ir.config_parameter'].sudo().get_param('purchase.update_product_price',
                                                                                    default=True)
    ...
    def product_price_update_before_done(self, forced_qty=None):
        ...
        'supplier', 'production') and move.product_id.cost_method == 'fifo'):
