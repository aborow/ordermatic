...
class MrpBom(models.Model):
	...
	def _update_bom_cost(self,parent_bom):
		...
		if bom:
			...
			list_total.append(round(lines_2.get('total'),2)/2)
			list_total.append(round(lines_4.get('total'),2)/4)
			list_total.append(round(lines_6.get('total'),2)/6)
			list_total.append(round(lines_10.get('total'),2)/10)
