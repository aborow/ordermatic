odoo.define('wibtec_mrp.mrp_expand_all', function (require) {
'use strict';
...
var MrpBomReport = stock_report_generic.extend({
    events: {
        ...
        'click .o_mrp_bom_expand_all': '_onClickUnfoldAll',
    },
    get_html: function() {
        var self = this;
        var args = [
    ...
    renderSearch: function () {
        ...
        this.$buttonPrint.filter('.o_mrp_bom_expand_all').on('click', this._onClickUnfoldAll.bind(this));
    ...
    _onClickUnfoldAll: function (ev) {
        var self = this;
        var $elements = $(self.$el).find('tr span.o_mrp_bom_unfoldable');
        $elements.each(function(index){
            var $el = $($elements[index]);
            $el.click();
            $el.removeClass("fa fa-fw o_mrp_bom_unfoldable fa-caret-right");
            $el.addClass("fa fa-fw o_mrp_bom_foldable fa-caret-down");
        })
    },
    _reload: function () {
        var self = this;
